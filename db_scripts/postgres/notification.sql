...
INSERT INTO wingspan.event_recipient (event_id, recipient, tag, target_url, updated_on, updated_by, classification, user_roles) VALUES ('discussion_comment_creation', 'author', '#discussionTopic,#comment,#targetUrl,#commentedByName', NULL, current_timestamp, '', 'Information', NULL);
...
<p>#commentedByName commented on #discussionTopic discussion topic with <b>#comment</b>. you can check the discussion <a href="#targetUrl">here.</a></p>
<br /> Thanks for now,<br /> <br /> The IGoT Team</p>

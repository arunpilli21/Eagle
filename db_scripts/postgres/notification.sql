...
INSERT INTO wingspan.event_recipient (event_id, recipient, tag, target_url, updated_on, updated_by, classification, user_roles) VALUES ('discussion_comment_creation', 'author', '#discussionTopic,#comment,#targetUrl,#commentedBy', NULL, current_timestamp, '', 'Information', NULL);
...
INSERT INTO wingspan.event_recipient (event_id, recipient, tag, target_url, updated_on, updated_by, classification, user_roles) VALUES ('discussion_upvote_event', 'author', '#upvotedBy,#comment,#targetUrl', NULL, current_timestamp, '', 'Information', NULL);
...
INSERT INTO wingspan.event_recipient (event_id, recipient, tag, target_url, updated_on, updated_by, classification, user_roles) VALUES ('discussion_downvote_event', 'author', '#downvotedBy,#comment,#targetUrl', NULL, current_timestamp, '', 'Information', NULL);
